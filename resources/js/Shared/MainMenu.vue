<template>
  <div>
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3 focus:outline-white" :href="route('dashboard')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3 focus:outline-white" :href="route('organizations')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3 focus:outline-white" :href="route('contacts')">
    ...
    <div class="mb-4">
      <inertia-link class="flex items-center group py-3 focus:outline-white" :href="route('reports')">
