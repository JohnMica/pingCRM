      ...
      <div class="md:h-screen md:flex md:flex-col">
        <div class="md:flex md:flex-shrink-0">
          <div class="bg-indigo-900 md:flex-shrink-0 md:w-56 px-6 py-4 flex items-center justify-between md:justify-center">
            <inertia-link class="mt-1 focus:outline-white" href="/">
              <logo class="fill-white" width="120" height="28" />
            </inertia-link>
            <dropdown class="md:hidden focus:ring focus:border-blue-300" placement="bottom-end">
          ...
          <div class="bg-white border-b w-full p-4 md:py-0 md:px-12 text-sm md:text-md flex justify-between items-center">
            ...
            <dropdown class="mt-1 focus:ring focus:border-blue-300" placement="bottom-end">
              ...
              <div slot="dropdown" class="mt-2 py-2 shadow-xl bg-white rounded text-sm text-left">
                <inertia-link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white focus:ring focus:border-blue-300" :href="route('users.edit', $page.props.auth.user.id)">My Profile</inertia-link>
                <inertia-link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white focus:ring focus:border-blue-300" :href="route('users')">Manage Users</inertia-link>
                <inertia-link class="block px-6 py-2 hover:bg-indigo-500 hover:text-white focus:ring focus:border-blue-300 w-full text-left" :href="route('logout')" method="post" as="button">Logout</inertia-link>
              </div>
            </dropdown>
          </div>
        </div>
